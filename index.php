...
$result=select("select * from books");
?>
<html lang="en">
...
else
{
	...
	<li class="nav-item active">
            ...
            <li class="nav-item">
              <a class="nav-link" href="ragister.php">Login/Register</a>
            </li>
			<?php
...
<form method="post" action="search_view.php">  
  <div class='cell'><input type='search' name= "country" id="country" placeholder='Type here...'></div>
  <div class='cell'><div> <button  class="btn btn-danger" name="onsearch" id="search_click">Search</button></div></div></div>
  </form>
  <div class="row">
...
<div class="container-fluid">
  ...
  <p style="color:red;font-weight:bold;font-size:20px;">NEW RELEASE<p>
</div>
        </div>
		 <div class="col-lg-1 text-center"></div>
